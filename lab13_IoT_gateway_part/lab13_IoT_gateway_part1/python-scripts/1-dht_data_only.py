...
INFLUXDB_TOKEN = "x6--rSfQbAVja7wRrnS7pL7gpzu0_n13MAT0aA1go4YClonnmtEfHxqldvOeK7QNn68nAs94TIpJ7l3rE5V2gQ=="  # Replace with your InfluxDB token
INFLUXDB_ORG = "my-org"      # Replace with your InfluxDB organization name
INFLUXDB_BUCKET = "My bucket"  # InfluxDB bucket name

# MQTT setup
MQTT_BROKER = "192.168.100.142"  # ESP32's MQTT broker address
